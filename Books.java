...
public class Books {
   ...
   private void writeBookToFile(Book b) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("book_details.txt", true))) {
            writer.write(
                    b.sNo + "\t\t" + b.bookName + "\t\t" + b.authorName + "\t\t" + b.bookQtyCopy + "\t\t" + b.bookQty);
            writer.newLine();
        } catch (IOException e) {
            e.printStackTrace();
        }
